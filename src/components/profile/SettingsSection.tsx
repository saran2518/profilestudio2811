...
const SettingsSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Safety */}
      <SettingsGroup title="Safety" icon="🛡️">
      ...
      {/* Notifications */}
      <SettingsGroup title="Notifications" icon="🔔">
        <SettingRow
