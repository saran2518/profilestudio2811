      ...
      >
        ...
        <div className="mt-3 flex justify-end">
          <motion.button
            ...
            onClick={onDateRoom}
            className="flex items-center gap-2 px-4 py-2 rounded-2xl transition-all border border-primary/20 hover:border-primary/40 hover:bg-primary/5"
          >
            <div className="relative">
              <Video className="h-4 w-4 text-primary" />
              <Plus className="h-2.5 w-2.5 text-primary-foreground bg-primary rounded-full absolute -top-1 -right-1.5" />
            </div>
            <span className="text-[11px] font-semibold text-primary">Virtual Date Room</span>
          </motion.button>
        </div>
      </div>
