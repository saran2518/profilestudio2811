          ...
          {activeSection === "profile" && (
            ...
            >
              ...
              >
                ...
                <div className="absolute top-0 left-0 right-0 pointer-events-none" style={{ height: "calc(3px + 5*4px + 58px + 16px + 24px + 4px + 18px + 16px)", background: "linear-gradient(to bottom, hsl(var(--primary) / 0.12), hsl(var(--primary) / 0.05))" }} />
