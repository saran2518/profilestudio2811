...
const EmailOTPVerification = () => {
  ...
  const email = (location.state as any)?.email || "johanaabraham1991@xmail.com";
  ...
  // Auto-verify when all 6 digits entered (UI only)
  useEffect(() => {
      ...
      >
        <div className="flex items-start justify-between relative">
          ...
          {ONBOARDING_STEPS.map((step, i) => {
            ...
            const isCompleted = i < currentStep || (verified && i === 3);
            return (
              <motion.div
                key={step.label}
